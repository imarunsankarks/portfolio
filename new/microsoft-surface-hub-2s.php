<?php
/*
Template Name: Microsoft Surface Hub 2S Template
*/
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description"
        content="Microsoft Surface Hub 2S is an interactive whiteboard doubling as a meeting screen, promoting cross-device collaboration with Microsoft 365, and leveraging cutting-edge tech for optimal sound and display.">

    <link rel="canonical" href="https://resurgent.co.in/microsoft-surface-hub-2s/" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Microsoft Surface Hub 2S - Resurgent AV Integrators PVT Ltd - AV Solutions" />
    <meta property="og:description"
        content="Microsoft Surface Hub 2S is an interactive whiteboard doubling as a meeting screen, promoting cross-device collaboration with Microsoft 365, and leveraging cutting-edge tech for optimal sound and display." />
    <meta property="og:url" content="https://resurgent.co.in/microsoft-surface-hub-2s/" />
    ...
    <meta property="og:image"
        content="<?php echo get_template_directory_uri(); ?>/assets/products/ms-surface-hub/microsoft-surface-hub-1.webp" />
                        ...
                        <div class="row g-5 align-items-center justify-content-center">
                            <div class="col-lg-7">
                                <div class="banner-product-img">
                                    <img loading="lazy"
                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/ms-surface-hub/hub-2s.webp"
                    ...
                    <div class="container">
                        <div class="row align-items-center g-4 g-md-0">
                            ...
                            <div class="product-feature-img">
                                <img loading="lazy"
                                    src="<?php echo get_template_directory_uri(); ?>/assets/products/ms-surface-hub/microsoft-surface-hub.webp"
                                    alt="">
                            ...
                            <div class="product-img-container">
                                <div class="product-imgs">
                                    <div class="product-img">
                                        <img loading="lazy"
                                            src="<?php echo get_template_directory_uri(); ?>/assets/products/ms-surface-hub/microsoft-surface-hub-contact.webp"
                                        ...
                                        <div class="container h-100">
                                            <div class="row h-100">
                                                <div class="other-cards">
                                                    <img loading="lazy"
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/ms-surface-hub/microsoft-surface-hub-1.webp"
                                                        alt="">
                                                    <div class="content">
                                                        <!-- <img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/logos/ouline.svg" alt=""> -->
                                    ...
                                    <div class="each-feature-card">
                                        <div class="container h-100">
                                            <div class="row h-100">
                                                <div class="other-cards">
                                                    <img loading="lazy"
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/ms-surface-hub/microsoft-surface-hub-4.webp"
                                                        alt="">
                                                    <div class="content">
                                    ...
                                    <div class="each-feature-card">
                                        <div class="container h-100">
                                            <div class="row h-100">
                                                <div class="other-cards">
                                                    <img loading="lazy"
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/ms-surface-hub/microsoft-surface-hub-3.webp"
                                                        alt="">
                                                    <div class="content">
