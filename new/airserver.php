<?php
/*
Template Name: Airserver Template
*/
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description" content="AirServer is a universal screen mirroring receiver, enabling users to display their screens from any device, whether it's a phone, tablet or laptop">

    <link rel="canonical" href="http://resurgent.co.in/airserver/" />
	<meta property="og:locale" content="en_US" />
	<meta property="og:type" content="article" />
	<meta property="og:title" content="AirServer - Resurgent AV Integrators PVT Ltd - AV Solutions" />
    <meta property="og:description" content="AirServer is a universal screen mirroring receiver, enabling users to display their screens from any device, whether it's a phone, tablet or laptop" />
	<meta property="og:url" content="http://resurgent.co.in/airserver/" />
	...
	<meta property="og:image" content="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/airserver-f3.webp" />
                        ...
                        <div class="row g-5 align-items-center justify-content-center">
                            <div class="col-lg-7">
                                <div class="banner-product-img">
                                    <img loading="lazy"
                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/airserver-connect-3.webp"
                            ...
                            <div class="col-lg-5">
                                <div class="banner-product-content">
                                    ...
                                    <div class="scroll">
                                        <img loading="lazy"
                                            src="<?php echo get_template_directory_uri(); ?>/assets/common/banner-arrow.svg"
                                            alt="">
                                        <p>scroll</p>
                                    </div>
                                </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center g-4 g-md-0">
                            ...
                            <div class="sectors-used pt-5">
                                <div class="row g-5">
                                    <div class="col-lg-3 col-md-6">
                                        <div class="each-sector-card">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/education.webp"
                                                alt="">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="each-sector-card">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/entertainment.webp"
                                                alt="">
                                            <div class=" sector-name">
                                                Entertainment
                                            </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="each-sector-card">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/business.webp"" alt="">
                                            <div class=" sector-name">
                                            Business
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="each-sector-card">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/live.webp"" alt="">
                                            <div class=" sector-name">
                                        Live streaming
                                    </div>
                                </div>
                            ...
                            <div class="product-img-container">
                                <div class="product-imgs">
                                    <div class="product-img">
                                        <img loading="lazy"
                                            src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/airserver-contact1.webp"
                                        ...
                                        <div class="container h-100">
                                            <div class="row h-100">
                                                <div class="other-cards">
                                                    <img loading="lazy"
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/airserver-f1.webp"
                                                        alt="">
                                                    <div class="content">
                                    ...
                                    <div class="each-feature-card">
                                        <div class="container h-100">
                                            <div class="row h-100">
                                                <div class="other-cards">
                                                    <img loading="lazy"
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/airserver-f2.webp"
                                                        alt="">
                                                    <div class="content">
                                    ...
                                    <div class="each-feature-card">
                                        <div class="container h-100">
                                            <div class="row h-100">
                                                <div class="other-cards">
                                                    <img loading="lazy"
                                                        src="<?php echo get_template_directory_uri(); ?>/assets/products/airserver/airserver-f3.webp"
                                                        alt="">
                                                    <div class="content">
